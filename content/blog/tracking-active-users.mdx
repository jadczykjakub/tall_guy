...
WebSockets were chosen because they allow real-time updates and the ability to detect when someone leaves a page or when their computer shuts down. Our WebSocket server can track this information, enabling us to handle such events efficiently.
