---
title: 'Git Bisect, the best bug hunter xd'
publishedAt: 'April 3, 2024'
author: 'Jakub Jadczyk'
published: true
imageSrc: 'blog/git-bisect/placeholder.png'
shortDescription: 'That"s the built-in tool in Git for finding specific commits'
---
...
![Bisect diagram](/blog/git-bisect/1.png)
